...
API_KEY = "c207ddeb6b793d421baef67d4d2b61d0"
...
def fetchWeeklyWeather(lon, lat, unit):
    ...
    API_URL = "http://api.openweathermap.org/data/3.0/onecall"
...
def fetchWeather(city, country, unit):
    ...
    API_URL = "http://api.openweathermap.org/data/3.0/weather"
    response = requests.get(url=API_URL, params=params)
...
def main(
    ...
    unit = inquirer.list_input("Metric or imperial?", choices=[
                               'metric', 'imperial'])
